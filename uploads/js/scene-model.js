/* scene-model.js — script thường. Sinh từ scene-model.mjs. */
(() => {
'use strict';
const INTRO_COPY = Object.freeze({
  label: 'CLIENT_BRIEF_HERO_COPY',
  heading: 'Give Us Your Hardest Problems',
  supporting: 'We build, deploy and operate AI systems to solve problems that once seemed impossible.',
});

const NEXT_COPY = Object.freeze({
  heading: 'Secondhuman.ai bridges the gap between AI models & business outcomes.',
  supporting: 'We work best with ambitious leaders determined to build radically more profitable businesses.',
});
...
const TRIANGLE_NODES = TRIANGLE_NETWORK.nodes;
const TRIANGLE_LINKS = TRIANGLE_NETWORK.links;
...
const PRIMARY_EXPANDED_PATH_IDS = Object.freeze([
  'expanded-west',
  'expanded-east',
  'expanded-north',
  'expanded-south',
...
const BASE_EXPANDED_PATH_IDS = Object.freeze([
...
const MARKERS = Object.freeze(markerSeeds.map(([pathId, t], index) => Object.freeze({
...
function validateSceneModel(paths, panels, markers) {
...
const PROBLEM_LABELS = Object.freeze([
  ...
  'Quality Issues', 'Cost Leakage', 'Manual Processes', 'Customer Complaints',
  'Forecasting Errors', 'Supplier Delays', 'Pricing Pressure', 'Reporting Delays',
  'Employee Turnover', 'Duplicate Work', 'Missed Deadlines',
]);

window.SH = Object.assign(window.SH || {}, { INTRO_COPY, NEXT_COPY, SCENE_LIMITS, PROBLEM_LABELS });
})();
